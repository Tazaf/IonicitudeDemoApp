...
if (!AR.build.mobile) {
    ...
    _PROPERTY_VALIDATOR = {
        TYPE: {
            ...
            RGBA: 13,
            NON_NEGATIVE: 14
        }, RULE: {MUST_BE_SET: 0, CAN_BE_EMPTY: 1}, validate: function (a, h, d, g, c) {
            var e = true;
            switch (g) {
    ...
    AR.om = {
        __currentObjectID__: 1, __objects__: [], registerObjectForID: function registerObjectForID(b, a) {
    ...
    AR.ARchitectObject = PClass.create({
        init: function () {
            ...
            if (!d) {
                AR.i.callAsync({objectId: this.__id, is: "AR.i.contextInterface.destroy"})
            }
                ...
                if (this[a] != undefined) {
                    try {
                        ...
                        if (contextInterface.info) {
                            AR.i.callAsync({is: "AR.i.contextInterface.info", message: "Exception caught: " + c})
                        }
                    }
                }
            }
    ...
    AR.ARObject = AR.ARchitectObject.extend({
        init: function (d) {
            ...
            this.__defineSetter__("enabled", function (h) {
                ...
                AR.i.callAsync({objectId: this.__id, enabled: h, is: "AR.i.arObjectInterface.setEnabled"});
                a = h
            });
            ...
            return arObjectInterface.isVisible({objectId: this.__id, is: "AR.i.arObjectInterface.isVisible"})
        }
    });
    ...
    AR.Drawable = AR.ARchitectObject.extend({
        init: function (b) {
            ...
            this.__defineSetter__("enabled", function (e) {
                ...
                AR.i.callAsync({objectId: this.__id, is: "AR.i.drawableInterface.setEnabled", enabled: e});
                a = e
            });
            this.__defineGetter__("enabled", function () {
                return a
            ...
            this.__defineSetter__("rotate", function (e) {
                ...
                AR.i.callAsync({is: "AR.i.drawableInterface.setRoll", objectId: this.__id, roll: d.roll});
                AR.i.callAsync({is: "AR.i.drawableInterface.setTilt", objectId: this.__id, tilt: d.tilt});
                AR.i.callAsync({is: "AR.i.drawableInterface.setHeading", objectId: this.__id, heading: d.heading})
            });
            ...
            return {enabled: a, onClickActive: c != null, roll: d.roll, tilt: d.tilt, heading: d.heading}
        }
    });
    AR.DrawableRotate = PClass.create({
        init: function (d, c) {
            ...
            this.__defineSetter__("roll", function (g) {
                ...
                AR.i.callAsync({objectId: f.__id, is: "AR.i.drawableInterface.setRoll", roll: g});
                b = g
            });
            this.__defineGetter__("roll", function () {
                if (f.__isDirty("rotate.roll")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.drawableInterface.getRoll"})
                }
                return b
            });
            this.__defineSetter__("tilt", function (g) {
                ...
                AR.i.callAsync({objectId: f.__id, is: "AR.i.drawableInterface.setTilt", tilt: g});
                a = g
            });
            this.__defineGetter__("tilt", function () {
                if (f.__isDirty("rotate.tilt")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.drawableInterface.getTilt"})
                }
                return a
            });
            this.__defineSetter__("heading", function (g) {
                ...
                AR.i.callAsync({objectId: f.__id, is: "AR.i.drawableInterface.setHeading", heading: g});
                e = g
            });
            this.__defineGetter__("heading", function () {
                if (f.__isDirty("rotate.heading")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.drawableInterface.getHeading"})
                }
                return e
            })
        }
    ...
    AR.Drawable2D = AR.Drawable.extend({
        validateHorizontalAnchor: function (a) {
            ...
            this.__defineSetter__("scale", function (m) {
                ...
                AR.i.callAsync({objectId: this.__id, is: "AR.i.drawable2DInterface.setScale", scale: m});
                g = m
            });
            this.__defineGetter__("scale", function () {
                if (this.__isDirty("scale")) {
                    return AR.i.callSync({objectId: this.__id, is: "AR.i.drawable2DInterface.getScale"})
                }
                return g
            });
            this.__defineSetter__("rotation", function (m) {
                m = this.validateRotation(m);
                AR.i.callAsync({objectId: this.__id, is: "AR.i.drawable2DInterface.setRotation", rotation: m});
                c = m
            });
            this.__defineGetter__("rotation", function () {
                if (this.__isDirty("rotation")) {
                    return AR.i.callSync({objectId: this.__id, is: "AR.i.drawable2DInterface.getRotation"})
                }
                return c
            });
            this.__defineSetter__("opacity", function (m) {
                m = this.validateOpacity(m);
                AR.i.callAsync({objectId: this.__id, is: "AR.i.drawable2DInterface.setOpacity", opacity: m});
                h = m
            });
            this.__defineGetter__("opacity", function () {
                if (this.__isDirty("opacity")) {
                    return AR.i.callSync({objectId: this.__id, is: "AR.i.drawable2DInterface.getOpacity"})
                }
                return h
            });
            ...
            this.__defineSetter__("offsetX", function (m) {
                ...
                AR.i.callAsync({objectId: this.__id, is: "AR.i.drawable2DInterface.setOffsetX", offsetX: m});
                e = m
            });
            this.__defineGetter__("offsetX", function () {
                if (this.__isDirty("offsetX")) {
                    return AR.i.callSync({objectId: this.__id, is: "AR.i.drawable2DInterface.getOffsetX"})
                }
                return e
            });
            this.__defineSetter__("offsetY", function (m) {
                m = this.validateOffsetY(m);
                AR.i.callAsync({objectId: this.__id, is: "AR.i.drawable2DInterface.setOffsetY", offsetY: m});
                d = m
            });
            this.__defineGetter__("offsetY", function () {
                if (this.__isDirty("offsetY")) {
                    return AR.i.callSync({objectId: this.__id, is: "AR.i.drawable2DInterface.getOffsetY"})
                }
                return d
            });
            this.__defineSetter__("zOrder", function (m) {
                m = this.validateZOrder(m);
                AR.i.callAsync({objectId: this.__id, is: "AR.i.drawable2DInterface.setZOrder", zOrder: m});
                k = m
            });
    ...
    AR.Label = AR.Drawable2D.extend({
        init: function (h, b, c) {
            ...
            this.__defineSetter__("text", function (i) {
                ...
                AR.i.callAsync({is: "AR.i.labelInterface.setText", objectId: d, text: i});
                f = i
            });
            ...
            this.__defineSetter__("height", function (i) {
                ...
                AR.i.callAsync({is: "AR.i.labelInterface.setHeight", objectId: d, height: i});
                e = i
            });
            this.__defineGetter__("height", function () {
                if (this.__isDirty("height")) {
                    return AR.i.callSync({is: "AR.i.labelInterface.getHeight", objectId: d})
                }
                return e
            });
    ...
    AR.ModelScale = PClass.create({
        init: function (e, d) {
            ...
            if (!f.__modelNotCreatedInCoreYet) {
                AR.i.callAsync({is: "AR.i.modelInterface.setScaleX", objectId: f.__id, scaleX: c});
                AR.i.callAsync({is: "AR.i.modelInterface.setScaleY", objectId: f.__id, scaleY: b});
                AR.i.callAsync({is: "AR.i.modelInterface.setScaleZ", objectId: f.__id, scaleZ: a})
            }
            this.__defineSetter__("x", function (g) {
                ...
                AR.i.callAsync({objectId: f.__id, scaleX: c, is: "AR.i.modelInterface.setScaleX"})
            });
            this.__defineGetter__("x", function () {
                if (!f.__modelNotCreatedInCoreYet && f.__isDirty("scale.x")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.modelInterface.getScaleX"})
                }
                return c
            });
            this.__defineSetter__("y", function (g) {
                ...
                AR.i.callAsync({objectId: f.__id, scaleY: b, is: "AR.i.modelInterface.setScaleY"})
            });
            this.__defineGetter__("y", function () {
                if (!f.__modelNotCreatedInCoreYet && f.__isDirty("scale.y")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.modelInterface.getScaleY"})
                }
                return b
            });
            this.__defineSetter__("z", function (g) {
                ...
                AR.i.callAsync({objectId: f.__id, scaleZ: a, is: "AR.i.modelInterface.setScaleZ"})
            });
            this.__defineGetter__("z", function () {
                if (!f.__modelNotCreatedInCoreYet && f.__isDirty("scale.z")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.modelInterface.getScaleZ"})
                }
                return a
            })
        }
    ...
    AR.ModelTranslate = PClass.create({
        init: function (e, d) {
            ...
            if (!f.__modelNotCreatedInCoreYet) {
                AR.i.callAsync({is: "AR.i.modelInterface.setTranslateX", objectId: f.__id, translateX: c});
                AR.i.callAsync({is: "AR.i.modelInterface.setTranslateY", objectId: f.__id, translateY: b});
                AR.i.callAsync({is: "AR.i.modelInterface.setTranslateZ", objectId: f.__id, translateZ: a})
            }
            this.__defineSetter__("x", function (g) {
                g = _PROPERTY_VALIDATOR.validate("translate.x", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({objectId: f.__id, is: "AR.i.modelInterface.setTranslateX", translateX: g});
                c = g
            });
            this.__defineGetter__("x", function () {
                if (!f.__modelNotCreatedInCoreYet && f.__isDirty("translate.x")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.modelInterface.getTranslateX"})
                }
                return c
            });
            this.__defineSetter__("y", function (g) {
                g = _PROPERTY_VALIDATOR.validate("translate.y", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({objectId: f.__id, is: "AR.i.modelInterface.setTranslateY", translateY: g});
                b = g
            });
            this.__defineGetter__("y", function () {
                if (!f.__modelNotCreatedInCoreYet && f.__isDirty("translate.y")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.modelInterface.getTranslateY"})
                }
                return b
            });
            this.__defineSetter__("z", function (g) {
                g = _PROPERTY_VALIDATOR.validate("translate.z", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({objectId: f.__id, is: "AR.i.modelInterface.setTranslateZ", translateZ: g});
                a = g
            });
            this.__defineGetter__("z", function () {
                if (!f.__modelNotCreatedInCoreYet && f.__isDirty("translate.z")) {
                    return AR.i.callSync({objectId: f.__id, is: "AR.i.modelInterface.getTranslateZ"})
                }
                return a
            })
        }
    ...
    AR.Circle = AR.Drawable2D.extend({
        init: function (b, c) {
            ...
            this.__defineSetter__("radius", function (g) {
                ...
                AR.i.callAsync({objectId: d, is: "AR.i.circleInterface.setRadius", radius: g});
                e = g
            });
            this.__defineGetter__("radius", function () {
                if (this.__isDirty("radius")) {
                    return AR.i.callSync({objectId: d, is: "AR.i.circleInterface.getRadius"})
                }
                return e
            });
    ...
    AR.HtmlDrawable = AR.Drawable2D.extend({
        init: function (m, k, d) {
            ...
            AR.i.callAsync({
                ...
                rotation: h.rotation,
                opacity: h.opacity,
                htmlOrUri: AR.__toJSONString__({html: a, uri: i}),
                viewportWidth: r,
                width: f,
                updateRate: j,
            ...
            this.__defineSetter__("html", function (s) {
                ...
                s = o(s);
                AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setHtml", objectId: c, html: s});
                a = s
            });
            ...
            this.__defineSetter__("uri", function (s) {
                ...
                AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setUri", objectId: c, uri: s});
                i = s
            });
            this.__defineGetter__("uri", function () {
                return i
            ...
            this.__defineSetter__("backgroundColor", function (s) {
                ...
                AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setBackgroundColor", objectId: c, backgroundColor: s});
                l = s
            });
            ...
            this.__defineSetter__("width", function (s) {
                ...
                AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setWidth", objectId: c, width: s});
                f = s
            });
            this.__defineGetter__("width", function () {
                if (this.__isDirty("width")) {
                    return AR.i.callSync({is: "AR.i.htmlDrawableInterface.getWidth", objectId: c})
                }
                return f
            });
            this.__defineSetter__("viewportWidth", function (s) {
                ...
                AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setViewportWidth", objectId: c, viewportWidth: s});
                r = s
            });
            ...
            this.__defineSetter__("updateRate", function (s) {
                ...
                AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setUpdateRate", objectId: c, updateRate: s});
                j = s
            });
            ...
            AR.i.callAsync({is: "AR.i.htmlDrawableInterface.evalJavaScript", objectId: this.__id, js: a})
        }
    });
    AR.HtmlDrawable.UPDATE_RATE = {
        STATIC: -1, LOW: 3, MEDIUM: 2, HIGH: 1, isValidUpdateRate: function (a) {
            switch (a) {
    ...
    AR.ImageDrawable = AR.Drawable2D.extend({
        init: function (f, a, b) {
            ...
            this.__defineSetter__("height", function (h) {
                ...
                AR.i.callAsync({is: "AR.i.imageDrawableInterface.setHeight", objectId: this.__id, height: h});
                d = h
            });
            this.__defineGetter__("height", function () {
                if (this.__isDirty("height")) {
                    AR.i.callSync({is: "AR.i.imageDrawableInterface.getHeight", objectId: this.__id})
                }
                return d
            });
    ...
    AR.Location = AR.ARchitectObject.extend({
        distanceTo: function (a) {
            ...
            return AR.i.callSync({is: "AR.i.locationInterface.distanceTo", objectId: this.__id, locationId: a.__id})
    ...
    AR.GeoLocation = AR.Location.extend({
        init: function (g, f, b) {
            ...
            this.__defineSetter__("latitude", function (h) {
                ...
                AR.i.callAsync({objectId: d, is: "AR.i.geoLocationInterface.setLatitude", latitude: h});
                a = h
            });
            this.__defineGetter__("latitude", function () {
                if (this.__isDirty("latitude")) {
                    return AR.i.callSync({objectId: d, is: "AR.i.geoLocationInterface.getLatitude"})
                }
                return a
            });
            this.__defineSetter__("longitude", function (h) {
                h = this.validateLongitude(h);
                AR.i.callAsync({objectId: d, is: "AR.i.geoLocationInterface.setLongitude", longitude: h});
                e = h
            });
            this.__defineGetter__("longitude", function () {
                if (this.__isDirty("longitude")) {
                    return AR.i.callSync({objectId: d, is: "AR.i.geoLocationInterface.getLongitude"})
                }
                return e
            });
            this.__defineSetter__("altitude", function (h) {
                h = this.validateAltitude(h);
                AR.i.callAsync({objectId: d, is: "AR.i.geoLocationInterface.setAltitude", altitude: h});
                c = h
            });
            this.__defineGetter__("altitude", function () {
                if (this.__isDirty("altitude")) {
                    return AR.i.callSync({objectId: d, is: "AR.i.geoLocationInterface.getAltitude"})
                }
                return c
            })
    ...
    AR.RelativeLocation = AR.Location.extend({
        init: function (g, a, e, c) {
            ...
            this.__defineSetter__("location", function (j) {
                ...
                if (j) {
                    AR.i.callAsync({is: "AR.i.relativeLocationInterface.setLocation", objectId: f, locationId: j.__id})
                } else {
                    AR.i.callAsync({is: "AR.i.relativeLocationInterface.setLocationRelativeToUser", objectId: f,})
                }
                h = j
            });
            ...
            this.__defineSetter__("northing", function (j) {
                ...
                AR.i.callAsync({is: "AR.i.relativeLocationInterface.setNorthing", objectId: f, northing: j});
                b = j
            });
            this.__defineGetter__("northing", function () {
                if (this.__isDirty("northing")) {
                    return AR.i.callSync({is: "AR.i.relativeLocationInterface.getNorthing", objectId: f})
                }
                return b
            });
            this.__defineSetter__("easting", function (j) {
                ...
                AR.i.callAsync({is: "AR.i.relativeLocationInterface.setEasting", objectId: f, easting: j});
                d = j
            });
            this.__defineGetter__("easting", function () {
                if (this.__isDirty("easting")) {
                    return AR.i.callSync({is: "AR.i.relativeLocationInterface.getEasting", objectId: f})
                }
                return d
            });
            this.__defineSetter__("altitudeDelta", function (j) {
                ...
                AR.i.callAsync({is: "AR.i.relativeLocationInterface.setAltitudeDelta", objectId: f, altitudeDelta: j});
                i = j
            });
            this.__defineGetter__("altitudeDelta", function () {
                if (this.__isDirty("altitudeDelta")) {
                    return AR.i.callSync({is: "AR.i.relativeLocationInterface.getAltitudeDelta", objectId: f})
                }
                return i
            })
        }
    ...
    AR.ActionArea = AR.ARchitectObject.extend({
        validateOnEnter: function (a) {
            ...
            this.__defineSetter__("enabled", function (e) {
                ...
                AR.i.callAsync({objectId: this.__id, is: "AR.i.actionAreaInterface.setEnabled", enabled: e});
                a = e
            });
            this.__defineGetter__("enabled", function () {
                return a
            ...
            return {enabled: a, onEnterTriggerActive: d != null, onExitTriggerActive: c != null}
        }, isInArea: function (a) {
            if (!AR.VALIDATE.isDefined(a)) {
    ...
    AR.ActionRange = AR.ActionArea.extend({
        init: function (b, a, d) {
            ...
            this.__defineSetter__("radius", function (h) {
                ...
                AR.i.callAsync({objectId: e, radius: h, is: "AR.i.actionRangeInterface.setRadius"});
                f = h
            });
            this.__defineGetter__("radius", function () {
                if (this.__isDirty("radius")) {
                    return AR.i.callSync({objectId: e, is: "AR.i.actionRangeInterface.getRadius"})
                }
                return f
            });
            this.__defineSetter__("location", function (h) {
                h = this.validateLocation(h);
                AR.i.callAsync({objectId: e, locationId: h.__id, is: "AR.i.actionRangeInterface.setLocation"});
                c = h
            });
            this.__defineGetter__("location", function () {
                return c
    ...
    AR.Animation = AR.ARchitectObject.extend({
        init: function (a) {
            ...
            return {onStartActive: c != null, onFinishActive: b != null}
        }, isRunning: function () {
            ...
            AR.i.callAsync({objectId: this.__id, is: "AR.i.animationInterface.start", loopTimes: a})
        }, stop: function () {
            AR.i.callAsync({objectId: this.__id, is: "AR.i.animationInterface.stop"});
            if (this instanceof AR.PropertyAnimation) {
    ...
    AR.PropertyAnimation = AR.Animation.extend({
        init: function (s, j, g, e, a, p, d) {
            ...
            if (!p || !(p.type)) {
                p = {type: AR.CONST.EASING_CURVE_TYPE.LINEAR}
            }
    ...
    AR.Sound = AR.ARchitectObject.extend({
        init: function (f, d) {
            ...
            this.__defineGetter__("state", function () {
                return AR.i.callSync({objectId: e, is: "AR.i.soundInterface.getState"})
            });
    ...
    AR.OneTimeUseContextConstructionPlan = PClass.create({
        validateFunction: function (a, b) {
            ...
            _destroyAll = function () {
                ...
                AR.i.callAsync({is: "AR.i.contextInterface.destroyAll"})
            };
            ...
            var b = function () {
                ...
                this.__defineSetter__("camera", function (h) {
                    ...
                    g = h;
                    AR.i.callAsync({is: "AR.i.contextInterface.setServiceEnabled", service: "camera", enabled: g})
                });
                ...
                this.__defineSetter__("sensors", function (h) {
                    ...
                    f = h;
                    AR.i.callAsync({is: "AR.i.contextInterface.setServiceEnabled", service: "sensors", enabled: f})
                })
            };
            var d = new b();
            ...
            var e = function () {
                ...
                this.__defineSetter__("cullingDistance", function (g) {
                    ...
                    f = g;
                    AR.i.callAsync({is: "AR.i.contextInterface.setCullingDistance", cullingDistance: f})
                })
            };
            var c = new e();
    ...
    AR.Tracker = AR.ARchitectObject.extend({
        init: function (g, c) {
            ...
            this.__defineSetter__("enabled", function (i) {
                ...
                AR.i.callAsync({objectId: d, is: "AR.i.trackerInterface.setEnabled", enabled: i})
            });
            this.__defineGetter__("enabled", function () {
                return AR.i.callSync({objectId: d, is: "AR.i.trackerInterface.getEnabled"})
            });
            ...
            return AR.i.callSync({objectId: this.__id, is: "AR.i.trackerInterface.isLoaded"})
        }
    });
    AR.Trackable2DObject = AR.ARObject.extend({
        init: function (f, e, c) {
            ...
            this.__defineGetter__("width", function () {
                var h = AR.i.callSync({objectId: d, is: "AR.i.trackable2DObjectInterface.getWidth"});
            ...
            this.__defineGetter__("height", function () {
                var h = AR.i.callSync({objectId: d, is: "AR.i.trackable2DObjectInterface.getHeight"});
                return h < 0 ? undefined : h
            });
            this.getDistance = function () {
                var h = AR.i.callSync({objectId: this.__id, is: "AR.i.trackable2DObjectInterface.getDistance"});
                return h < 0 ? undefined : h
            }
        }
    });
    AR.OneTimeUseRadarConstructionPlan = PClass.create({
        init: function () {
            ...
            this.__defineSetter__("enabled", function (l) {
                ...
                f = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setEnabled", enabled: l})
            });
            this.__defineGetter__("enabled", function () {
                return f
            });
            ...
            this.__defineSetter__("positionX", function (l) {
                ...
                j = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setPositionX", positionX: l})
            });
            ...
            this.__defineSetter__("positionY", function (l) {
                ...
                i = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setPositionY", positionY: l})
            });
            ...
            this.__defineSetter__("width", function (l) {
                ...
                e = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setWidth", width: l})
            });
            this.__defineGetter__("width", function () {
                return e
            });
            this.__defineSetter__("centerX", function (l) {
                ...
                d = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setCenterX", centerX: l})
            });
            ...
            this.__defineSetter__("centerY", function (l) {
                ...
                c = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setCenterY", centerY: l})
            });
            ...
            this.__defineSetter__("radius", function (l) {
                ...
                a = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setRadius", radius: l})
            });
            this.__defineGetter__("radius", function () {
                return a
            });
            this.__defineSetter__("maxDistance", function (l) {
                ...
                k = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setMaxDistance", maxDistance: (l ? l : -1)})
            });
            ...
            this.__defineSetter__("onClick", function (l) {
                ...
                g = l;
                AR.i.callAsync({is: "AR.i.radarInterface.setOnClickTriggerActive", onClickTriggerActive: l != null})
            });
            this.__defineGetter__("onClick", function () {
                return g
            });
    ...
    AR._NorthIndicator = PClass.create({
        init: function () {
            ...
            this.__defineSetter__("radius", function (c) {
                ...
                a = c;
                AR.i.callAsync({is: "AR.i.radarInterface.setNorthIndicatorRadius", northIndicatorRadius: c})
            });
            this.__defineGetter__("radius", function () {
                return a
            })
    ...
    AR.Drawable.prototype.__defineGetter__("triggers", function () {
        if (!this._triggers) {
            this._triggers = new AR.DrawableTriggers(this, {onClick: this.onClick})
        }
    ...
    AR.overlay.__OVERLAY_CONTAINER__CONSTRUCTION_PLAN = function () {
        ...
        this.appendOverlay = function (r, s, p) {
            ...
            c.appendChild(q);
            m.appendChild(s);
            i[f] = {tab: q, htmlElement: s, initFunction: p};
            f++;
            j++;
            return f - 1
        };
    ...
    var __ARCHITECT_LOGGER_FRAMEWORK__ = new function () {
        ...
        h();
        var g = {ERROR: [true, "red"], WARNING: [true, "orange"], INFO: [false, "green"], DEBUG: [false, "grey"]};
    ...
    AR.ADE.Screen = function () {
        ...
        var f = function () {
            ...
            var s = function () {
                ...
                if (I != null && AR.VALIDATE.isInRange(I, -90, 90)) {
                } else {
                    q("currentLatitude");
                    return
                }
                if (H != null && AR.VALIDATE.isInRange(H, -180, 180)) {
                } else {
                    q("currentLongitude");
                    return
                }
                if (G != null && AR.VALIDATE.isNumeric(G) && !isNaN(G)) {
                } else {
                    q("currentAltitude");
                    return
                }
    ...
    AR.ADE.ConstructionPlan = function () {
        ...
        this.simulatedLocation = {latitude: 0, longitude: 0, altitude: 0, accuracy: AR.CONST.LOCATION_ACCURACY.HIGH};
        ...
        this.loadAllRessourcesNow = function () {
            for (objectId in AR.om.__objects__) {
                ...
                if (f instanceof AR.ImageResource) {
                    AR.i.imageResourceInterface.startLoading({objectId: f.__id})
                } else {
                    if (f instanceof AR.Tracker) {
                        AR.i.trackerInterface.startLoading({objectId: f.__id})
                    } else {
                        if (f instanceof AR.HtmlDrawable) {
                            AR.i.htmlDrawableInterface.startLoading({objectId: f.__id})
                        } else {
                            if (f instanceof AR.Sound) {
                                AR.i.soundInterface.simulateLoad({objectId: f.__id})
                            } else {
                                if (f instanceof AR.Model) {
                                    AR.i.modelInterface.simulateLoad({objectId: f.__id})
                                }
                            }
                        }
                    }
                ...
                if (g instanceof AR.ARObject) {
                    ...
                    for (var h = 0; h < j.length; h++) {
                        if (j[h].__id == n) {
                            ...
                            l.push({id: g.__id, bo: m.explain()})
                        }
                    }
                }
            }
            var f = function (o, i) {
                var p = {drawables: [{drawable: n, arObject: i}], arObjects: [i]};
    ...
    AR.ADE.Tree = function (b) {
        ...
        this.objectCreated = function (p) {
            ...
            var n = new g(p, o, {node: m.getRoot()});
            m.render()
        };
        ...
        var g = function (r, q, o) {
            ...
            var p = {id: r, label: q.type + " (#" + r + ")", expanded: false, node: this};
        ...
        var e = function (u, n, t, p) {
            ...
            if (t.value) {
                ...
                var q = {id: t.value, label: n + ": " + r.type + " (#" + t.value + ")", expanded: false, node: this};
        ...
        var i = function (r, n, q, o) {
            ...
            var p = {label: n + ": " + q, id: r + "_" + n, expanded: false};
            this.value = q;
            this.node = new YAHOO.widget.TextNode(p, o.node);
        ...
        var d = function (s, o, r, p) {
            ...
            var q = {label: o, id: s + "_" + o, expanded: false};
            if (r.active) {
                q.href = n(s, r)
            }
            this.node = new YAHOO.widget.TextNode(q, p.node);
        ...
        setScaleX: function (a) {
            ...
            if (!a._loaded && !a.loading) {
                ...
                window.setTimeout(function () {
                    AR.i.modelInterface.simulateLoad({objectId: b.objectId})
                }, Math.random() * 5000)
            }
    ...
    AR.i.htmlDrawableInterface = {
        setHtml: function (b) {
            ...
            if (AR.ADE.instance.autoLoadResources) {
                window.setTimeout(function () {
                    AR.i.htmlDrawableInterface.simulateLoad({objectId: b.objectId})
                }, Math.random() * 5000)
            }
            AR.ADE.instance.alertModification(b.objectId)
        }, setUri: function (b) {
    ...
    AR.i.imageResourceInterface = {
        setOnLoadedTriggerActive: function (a) {
            ...
            if (!a._loaded && !a.loading) {
                a.loading = true;
                window.setTimeout(function () {
                    AR.i.imageResourceInterface.simulateLoad({objectId: b.objectId})
                }, Math.random() * 5000)
            }
        }, simulateLoad: function (c) {
            var b = AR.i.getBridgeObject(c.objectId);
            ...
            b._loaded = true;
            if (a.onLoaded != null) {
                a.onLoaded(AR.i.imageResourceInterface.getWidth({objectId: a.__id}), AR.i.imageResourceInterface.getHeight({objectId: a.__id}))
            }
            AR.ADE.instance.alertModification(c.objectId)
        }
    };
    AR.i.soundInterface = {
        createSound: function (a) {
            ...
            if (!a._loaded) {
                window.setTimeout(function () {
                    AR.i.soundInterface.simulateStreaming({objectId: b.objectId})
                }, Math.random() * 5000)
            } else {
                a._state = AR.CONST.STATE.PLAYING;
                window.setTimeout(function () {
                    if (!AR.i.getBridgeObject(b.objectId)._stopped) {
                        AR.i.soundInterface.simulatePlay({objectId: b.objectId})
                    }
        ...
        createPropertyAnimation: function (a) {
            ...
            var k = function () {
                if (f.runningId) {
                    ...
                    a[g[g.length - 1]] = h;
                    if ((d.loopTimes - 1) != 0) {
                        AR.i.propertyAnimationInterface.start({objectId: d.objectId, loopTimes: (d.loopTimes - 1)})
                    } else {
                        if (c.onFinish != null) {
                            c.onFinish()
                        }
        ...
        createAnimationGroup: function (a) {
            ...
            if (e._type == "parallel") {
                for (var d = 0; d < a.length; d++) {
                    var f = a[d];
                    AR.i.callAsync({objectId: f, is: "AR.i.animationInterface.start", loopTimes: 1})
                }
            } else {
                if (e._type == "sequential") {
                    ...
                    var b = function (i, h) {
                        window.setTimeout(function () {
                            AR.i.callAsync({objectId: i, is: "AR.i.animationInterface.start", loopTimes: 1})
                        }, h)
                    };
                    for (var d = 0; d < a.length; d++) {
                        var f = a[d];
            ...
            if (g.loopTimes - 1 != 0) {
                window.setTimeout(function () {
                    if (e.running) {
                        AR.i.animationGroupInterface.start({objectId: g.objectId, loopTimes: g.loopTimes - 1})
                    }
            ...
            for (var b = 0; b < a.length; b++) {
                var d = a[b];
                AR.i.callAsync({objectId: d, is: "AR.i.animationInterface.stop"})
            }
        }, isRunning: function (b) {
            var a = AR.i.getBridgeObject(b.objectId);
            return a.running
    ...
    AR.i.trackerInterface = {
        setEnabled: function (a) {
            ...
            if (!a._isLoaded && !a.loading) {
                a.loading = true;
                window.setTimeout(function () {
                    AR.i.trackerInterface.simulateLoad({objectId: b.objectId})
                }, Math.random() * 5000)
            }
        }, simulateLoad: function (c) {
            var b = AR.i.getBridgeObject(c.objectId);
            ...
            AR.i.registerBridgeObject({
                ...
                explain: function () {
                    return {
                        ...
                        properties: {
                            tracker: {type: "id", value: this._tracker},
